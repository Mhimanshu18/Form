...
ampIndividual[i_] := FCFAConvert[CreateFeynAmp[Take[diags,{i}]], IncomingMomenta->{p1,k1},
	OutgoingMomenta->{p2,k2},UndoChiralSplittings->True,ChangeDimension->4,
	TransversePolarizationVectors->{k1,k2}, List->False, SMP->True,
	Contract->True]


mimjs[i_,j_] := (ampIndividual[i] (ComplexConjugate[ampIndividual[j]]))//
	FeynAmpDenominatorExplicit//
	DoPolarizationSums[#,k1,0]&//DoPolarizationSums[#,k2,0]&//
	FermionSpinSum[#, ExtraFactor -> 1/2^2]&
...
mimjs[1,1]
mimjs[1,1]//DiracSimplify//TrickMandelstam[#,{s,t,u,2SMP["m_e"]^2}]&//Simplify


mimjs[1,2]
mimjs[1,2]//DiracSimplify//TrickMandelstam[#,{s,t,u,2SMP["m_e"]^2}]&//Simplify


mimjs[2,1]
mimjs[2,1]//DiracSimplify//TrickMandelstam[#,{s,t,u,2SMP["m_e"]^2}]&//Simplify


mimjs[2,2]
mimjs[2,2]//DiracSimplify//TrickMandelstam[#,{s,t,u,2SMP["m_e"]^2}]&//Simplify
